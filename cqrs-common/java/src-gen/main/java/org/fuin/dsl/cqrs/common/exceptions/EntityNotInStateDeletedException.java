...
public final class EntityNotInStateDeletedException extends UniquelyNumberedException {
    ...
    public EntityNotInStateDeletedException(final EntityIdPath entityIdPath) {
        super(1001, Objects.requireNonNull(KeyValueEL.replace("Expected the entity to be in state 'deleted', but was not: ${entityIdPath}",  new KeyValue("entityIdPath", entityIdPath))));
