 ...
 */
public abstract class AbstractComment implements ValueObject, Serializable {
     ...
     */
    public AbstractComment(final MediaType mimeType, @Size(min=1, max=2000) final String value) {
        super();
