...
public final class PhoneNumber implements ValueObjectWithBaseType<String>, Comparable<PhoneNumber>, Serializable, AsStringCapable {
    ...
    @Documented
    public @interface PhoneNumberStr {

        String message()

        default "{org.fuin.dsl.cqrs.common.basics.PhoneNumber.message}";
    ...
    public static final class Validator implements
            ConstraintValidator<PhoneNumberStr, String> {

        @Override
        public void initialize(
                final PhoneNumberStr annotation) {
            // Not used
        }
