import 'package:cqrs_common/src-gen/common/basics/media_type.dart';
...
class Comment {
  ...
  factory Comment.fromJson(Map<String, dynamic> json) => Comment(
        mimeType: MediaType(requiredString(json, 'mimeType')),
  ...
  Object? operator [](String attribute) => switch (attribute) {
        ...
        'value' => value,
        _ => throw ArgumentError("Comment has no attribute '$attribute'"),
      };
  ...
  @override
  int get hashCode => Object.hash(mimeType, value);

  @override
  String toString() => 'Comment[mimeType=${mimeType.value}, value=$value]';
}
