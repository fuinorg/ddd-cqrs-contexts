 ...
 */
public final class EntityInStateDeletedException extends UniquelyNumberedBusinessRuleViolationException {
    ...
    public EntityInStateDeletedException(final EntityIdPath entityIdPath) {
        super(1002, Objects.requireNonNull(KeyValueEL.replace("Expected the entity to be in normal state, but was 'deleted': ${entityIdPath}",  new KeyValue("entityIdPath", entityIdPath))));
