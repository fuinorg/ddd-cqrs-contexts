...
public final class EmailAddress implements ValueObjectWithBaseType<String>, Comparable<EmailAddress>, Serializable, AsStringCapable {
    ...
    public @interface EmailAddressStr {
        ...
        default "{org.fuin.dsl.cqrs.common.basics.EmailAddress.message}";
    ...
    public static final class Validator implements
            ConstraintValidator<EmailAddressStr, String> {

        @Override
        public void initialize(
                final EmailAddressStr annotation) {
            // Not used
        }
